...
var trelloTables = {
  projectCards: {board: "55465e8f9d78f90662b93472", sheet: "Project Cards", type: "cards", props: ["name", "id", "idList", "idMembers", "due", "url"]},
  projectLists: {board: "55465e8f9d78f90662b93472", sheet: "Project Lists", type: "lists", props: ["id", "name"]},
  projectMembers: {board: "55465e8f9d78f90662b93472", sheet: "Project Members", type: "members", props: ["id", "fullName", "username"]},
  vendorCards: {board: "5ab0486838e9f3a344df250a", sheet: "Vendor Cards", type: "cards", props: ["name", "id", "idList", "idMembers", "due", "url"]},
  vendorLists: {board: "5ab0486838e9f3a344df250a", sheet: "Vendor Lists", type: "lists", props: ["id", "name"]}
};
